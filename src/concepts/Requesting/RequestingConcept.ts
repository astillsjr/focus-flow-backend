...
import { createUnifiedEventStream } from "./sse-stream.ts";
...
export function startRequestingServer(
   ...
   */
  const unifiedEventStream = createUnifiedEventStream({
    UserAuthentication: concepts.UserAuthentication,
    NudgeEngine: concepts.NudgeEngine,
    TaskManager: concepts.TaskManager,
    EmotionLogger: concepts.EmotionLogger,
    MicroBet: concepts.MicroBet,
  });
